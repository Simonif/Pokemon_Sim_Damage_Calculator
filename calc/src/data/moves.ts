...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Outrage: {bp: 120, makesContact: true},
  'Petal Dance': { bp: 120,makesContact: true},
  ...
  Thrash: { bp: 120, makesContact: true},
  ...
  'Hidden Power Bug': {bp: 70, type: 'Bug', makesContact: false},
  'Hidden Power Dark': {bp: 70, type: 'Dark', makesContact: false},
  'Hidden Power Dragon': {bp: 70, type: 'Dragon', makesContact: false},
  'Hidden Power Electric': {bp: 70, type: 'Electric', makesContact: false},
  'Hidden Power Fighting': {bp: 70, type: 'Fighting', makesContact: false},
  'Hidden Power Fire': {bp: 70, type: 'Fire', makesContact: false},
  'Hidden Power Flying': {bp: 70, type: 'Flying', makesContact: false},
  'Hidden Power Ghost': {bp: 70, type: 'Ghost', makesContact: false},
  'Hidden Power Grass': {bp: 70, type: 'Grass', makesContact: false},
  'Hidden Power Ground': {bp: 70, type: 'Ground', makesContact: false},
  'Hidden Power Ice': {bp: 70, type: 'Ice', makesContact: false},
  'Hidden Power Poison': {bp: 70, type: 'Poison', makesContact: false},
  'Hidden Power Psychic': {bp: 70, type: 'Psychic', makesContact: false},
  'Hidden Power Rock': {bp: 70, type: 'Rock', makesContact: false},
  'Hidden Power Steel': {bp: 70, type: 'Steel', makesContact: false},
  'Hidden Power Water': {bp: 70, type: 'Water', makesContact: false},
  'Giga Drain': { bp: 75 },
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Thunderpunch': {isPunch: true, category: 'Physical'},
